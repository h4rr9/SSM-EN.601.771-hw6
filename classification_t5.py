...
if __name__ == "__main__":
    ...
    parser.add_argument("--small_subset", default=False, action="store_true")
    ...
    writer = SummaryWriter(
        comment=f"_{args.experiment}_model={args.model}_lr={args.lr}_bs={args.batch_size}_nep={args.num_epochs}_smallsubset={args.small_subset}"
    )
